...
{
    echo '<td><input type="button" id="'.$row['teamId'].'" idL="'.$row['leagueId'].'" align="center" class="btn btn-success Team" value="'.$row['teamName'].'"></td>';
}?>
</div>
	...
	$(document).ready(function(){
		...
		$(".Team").on('click', function(){
			{   
				...
				$.post("RecrutingManage.php", {TeamId : TeamId, LeagueId: LeagueId}, function(data){
					$("#Team").html(data);
				});
			}
		});
