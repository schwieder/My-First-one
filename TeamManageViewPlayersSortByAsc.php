...
echo '</tr><tbody class="gridtable">';
    ...
    foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM hkyplayers WHERE teamId = ".$TeamId." && year < 5 ORDER by ".$Sort." ASC")) as $row)
    {
        echo '<tr>';
     ...
     $(".Edit").on('click', function(){			
        {
            ...
            $.post("TeamManageEditPlayer.php", {TeamId : TeamId, playerId : playerId}, function(data){
                $("#Team2").html(data);
            });
        }
</script>
