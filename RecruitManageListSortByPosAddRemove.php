...
echo '</tr><tbody class="gridtable">';
    ...
    foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM recruits WHERE leagueId = ".$LeagueId." AND ".$List." = 'Y' ORDER by position ASC")) as $row)
    {
    ...
    $(".Remove").on('click', function(){			
        {
            ...
            var LeagueId = <?php echo $LeagueId; ?>;
            var YN = "N";
            $.post("RecruitManageListSortByPosAddRemove.php", {YN : YN, recruitId : recruitId, teamNo : teamNo, LeagueId: LeagueId, TeamId: TeamId}, function(data){
                $("#Team2").html(data);
            });
        }
    });
