...
echo '</tr><tbody class="gridtable">';
    ...
    foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM recruits WHERE leagueId = ".$LeagueId." ORDER by position ASC")) as $row)
    {
     ...
     $(".Add").on('click', function(){			
        {
            ...
            var LeagueId = <?php echo $LeagueId; ?>;
            var YN = "Y";
            $.post("RecruitManageByPosAddRemove.php", {YN : YN, recruitId : recruitId, teamNo : teamNo, LeagueId: LeagueId, TeamId: TeamId}, function(data){
                $("#Team2").html(data);
            });
        }
    });
