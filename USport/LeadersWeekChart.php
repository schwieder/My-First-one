<?php
	...
	echo '<br><input type="button" rel="PassYds" fart="QB" id="'.$LeagueId.'" align="right" style="height:20px;width:150px;" class="btn btn-success FA" value="QB"> &nbsp';
	echo '<input type="button" rel="RushYds" fart="RB" id="'.$LeagueId.'" align="right" style="height:20px;width:150px;" class="btn btn-success FA" value="RB"> &nbsp';
	echo '<input type="button" rel="RecYds" fart="WR" id="'.$LeagueId.'" align="right" style="height:20px;width:150px;" class="btn btn-success FA" value="WR"> &nbsp';
	...
	echo '<input type="button" rel="KickPts" fart="K" id="'.$LeagueId.'" align="right" style="height:20px;width:150px;" class="btn btn-success FA" value="K"> &nbsp';
    ...
    if($Pos == "QB")
    {
        ...
        if($Sort == 'Name')
        {
            foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && Pos ='QB' ORDER BY $Sort")) as $row)
            {
        ...
        {
            foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && Pos ='QB' ORDER BY $Sort DESC")) as $row)
            {
                    if (!in_array($row['PlayerId'], $taken))
                {
                    $PId = $row['PlayerId'];
    ...
    if($Pos == "RB")
    {
        ...
        if($Sort == 'Name')
        {
            foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && Pos ='RB' ORDER BY $Sort")) as $row)
            {
                if (!in_array($row['PlayerId'], $taken))
                {
                    $PId = $row['PlayerId'];
        ...
        {
            foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && Pos ='RB' ORDER BY $Sort DESC")) as $row)
            {
                    if (!in_array($row['PlayerId'], $taken))
                {
                    $PId = $row['PlayerId'];
    ...
    if($Pos == "WR")
    {
        ...
        if($Sort == 'Name')
        {
            foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && Pos ='WR' ORDER BY $Sort")) as $row)
            {
                if (!in_array($row['PlayerId'], $taken))
                {
                    $PId = $row['PlayerId'];
        ...
        {
            foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && Pos ='WR' ORDER BY $Sort DESC")) as $row)
            {
                    if (!in_array($row['PlayerId'], $taken))
                {
                    $PId = $row['PlayerId'];
    ...
    if($Pos == "K")
    {
        ...
        if($Sort == 'KickPts')
        {
            foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && Pos ='K' ORDER BY $Sort DESC")) as $row)
            {
                    if (!in_array($row['PlayerId'], $taken))
                {
                    $PId = $row['PlayerId'];
        ...
        {
            foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && Pos ='K' ORDER BY $Sort")) as $row)
            {
                if (!in_array($row['PlayerId'], $taken))
                {
                    $PId = $row['PlayerId'];
...
if($Pos == "Ret")
{
    ...
    if($Sort == 'KORYds')
    {
        foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && KORYds !='0' ORDER BY KORYds DESC")) as $row)
        {
                if (!in_array($row['PlayerId'], $taken))
            {
                $PId = $row['PlayerId'];
    ...
    {
        foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && KORYds !='0' ORDER BY KORTds DESC")) as $row)
        {
                if (!in_array($row['PlayerId'], $taken))
            {
                $PId = $row['PlayerId'];
    ...
    {
        foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && PRYds !='0' ORDER BY PRYds DESC")) as $row)
        {
                if (!in_array($row['PlayerId'], $taken))
            {
                $PId = $row['PlayerId'];
    ...
    {
        foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && PRYds !='0' ORDER BY PRTds DESC")) as $row)
        {
                if (!in_array($row['PlayerId'], $taken))
            {
                $PId = $row['PlayerId'];
    ...
    {
        foreach(MysqlFetchData(ExecuteSqlQuery("SELECT * FROM stats WHERE Week=$week && KORYds !='0' ORDER BY $Sort")) as $row)
        {
            if (!in_array($row['PlayerId'], $taken))
            {
                $PId = $row['PlayerId'];
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".FA").on('click', function(){
			...
			$.post("LeadersWeekChart.php", {Week:Week, Pos: Pos, LId: LId, Sort:Sort}, function(data){
				$("#TeamInner").html(data);
			});	
		});
